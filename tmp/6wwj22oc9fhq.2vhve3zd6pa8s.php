        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <select id="section" name="section" class="form-control" style="display: inherit;" required>
                            <option value="">--Select Section--</option>
                            <?php foreach (($sections?:[]) as $key=>$section): ?>
                                <option value="<?= ($section['sct_id']) ?>"><?= ($section['sct_title']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
...
function($) {
    ...
    function generateFullReport() {
        ...
        var url = "./reports/monthly/"+section+"/"+year+"/"+month;
