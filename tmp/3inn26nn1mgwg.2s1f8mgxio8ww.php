...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-success  m-t-10" id="totalEntry"></h3>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-primary  m-t-10" id="gymEntry"></h3>
                    <p class="text-muted text-nowrap m-b-10">Total Gym Entry Today</p>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-pink m-t-10" id="foyerEntry"></h3>
                    <p class="text-muted text-nowrap m-b-10">Total Foyer Entry Today</p>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-danger  m-t-10" id="gymExit"></h3>
                    <p class="text-muted text-nowrap m-b-10">Total Exit Today</p>
                </div>
            </div>
        </div>
        <!-- end row -->
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-success m-t-10" id="totalEntryYTD"></h3>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-primary  m-t-10" id="gymEntryYTD"></h3>
                    <p class="text-muted text-nowrap m-b-10"> Total Gym Entry Yesterday</p>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-pink m-t-10" id="foyerEntryYTD"></h3>
                    <p class="text-muted text-nowrap m-b-10">Total Foyer Entry Yesterday</p>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-danger m-t-10" id="gymExitYTD"></h3>
                    <p class="text-muted text-nowrap m-b-10"> Total Exit Yesterday</p>
                </div>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-success m-t-10" id="totalTemps"></h3>
                    <p class="text-muted text-nowrap m-b-10">Total Temperature</p>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-primary  m-t-10" id="highTemps"></h3>
                    <p class="text-muted text-nowrap m-b-10"> High Temp</p>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-pink m-t-10" id="normalTemps"></h3>
                    <p class="text-muted text-nowrap m-b-10">Normal Temp</p>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    <h3 class="text-danger m-t-10" id="lowTemps"></h3>
                    <p class="text-muted text-nowrap m-b-10">Low Temp</p>
                </div>
            </div>
        </div>
        <!-- end row -->
...
<script>
    ...
    function refreshDashboard() {
        ...
        $.get("./get_display_top_temp/4/" + year + "/" + month, function (data, status) {
            ...
            $("#totalEntry").html(data.totalEntry);
            $("#gymEntry").html(data.gymEntry);
            $("#foyerEntry").html(data.foyerEntry);
            $("#gymExit").html(data.gymExit);


            $("#totalEntryYTD").html(data.totalEntryYTD);
            $("#gymEntryYTD").html(data.gymEntryYTD);
            $("#foyerEntryYTD").html(data.foyerEntryYTD);
            $("#gymExitYTD").html(data.gymExitYTD);

            $("#totalTemps").html(data.totalTemps);
            $("#highTemps").html(data.highTemps);
            $("#lowTemps").html(data.lowTemps);
            $("#normalTemps").html(data.normalTemps);
