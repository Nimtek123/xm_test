                        ...
                        <form method="POST" action="/users/create">
                            <div class="row">
                                <div class="mb-2 col-md-6">
                                    <label for="usr_name" class="form-label">First Name</label>
                                    <input type="text" class="form-control" id="usr_name"  name="usr_name" placeholder="First Name">
                                </div>
                                <div class="mb-2 col-md-6">
                                    <label for="usr_surname" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="usr_surname" name="usr_surname" placeholder="Last Name">
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-2 col-md-6">
