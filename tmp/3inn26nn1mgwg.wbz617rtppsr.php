                            ...
                            <table id="datatable-buttons" class="table table-buttons datatable table-bordered table-bordered dt-responsive nowrap"
                                ...
                                <thead class="thead-default">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-strong">Gender</th>
                                        <th class="text-strong">UserID</th>
...
" ?>
                                            ...
                                            <td>
                                                <?php if ($SESSION['USER']['role'] == '1'): ?>
                                                    <a href="/usercat/update/<?= ($value['id']) ?>" class="btn btn-info">Edit</a> 
                                                    <a href="/usercat/delete/<?= ($value['id']) ?>" class="btn btn-danger">Delete</a>
                                                <?php endif; ?> 
                                            </td>
