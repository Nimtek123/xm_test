                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="datatable" class="datatable table table-bordered table-bordered dt-responsive nowrap"
                                cellspacing="0" width="100%">

                                <thead class="thead-default">

                                    <tr>
                                        <th class="text-strong sorting_desc">Date</th>
                                        <?php if ($tmpImg == 'true'): ?>
                                            <th class="text-strong">Image</th>
                                        <?php endif; ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <a class="thumbnail fancybox " rel="ligthbox" href='#'>
                                                                <?php if (strpos($value['tmp_imageData'], 'https')  > -1): ?>
                                                                    <img src="<?= ($value['tmp_imageData']) ?>"
                                                                    height="100px">
                                                                    <?php else: ?>
                                                                        <img src="data://text/plain;base64,<?= ($value['tmp_imageData']) ?>"
                                                                        height="100px">
...
" ?>
                                            ...
                                            <td>
                                                ...
                                                <a href="/temperature/editTemperature/<?= ($value['tmp_id']) ?>" class="btn btn-info">Edit</a> 
                                                <?php endif; ?>
                                            </td>
