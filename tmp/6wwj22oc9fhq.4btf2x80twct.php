                            ...
                            <td>
                                <select id="month" name="month" class="form-control" style="display: inherit;" required>
                                    ...
                                    <?php foreach (($months?:[]) as $key=>$month): ?>
                                        <option value="<?= ($key) ?>" <?php if ($month == $POST['month']): ?>selected="selected"<?php endif; ?>><?= ($month) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                        </tr>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    ...
                    <p class="text-muted text-nowrap m-b-10">Traffic <?= ($POST['month']) ?></p>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="widget-simple-chart text-center card-box">
                    ...
                    <p class="text-muted text-nowrap m-b-10">Traffic Year <?= ($POST['year']) ?></p>
                </div>
            </div>
        </div>
        <!-- end row -->
...
<script>
    ...
    function refreshDashboard() {
        ...
        var date = new Date();
        var d = date.getDate();
        var month = $("#month").val();//date.getMonth() + 1;
                ...
                "titles": [
                    {
                        "id": "Title-1",
                        "size": 15,
                        "text": "Traffic Flow Per Week <?= ($POST['year']) ?>"
                    }
                ],
