    ...
    <div class="container-fluid">
        <header class="content__title">
            ...
            <?php if ($SESSION['USER']['role'] == '1'): ?>
                <!-- <a href="/usercat/create" class="btn btn-primary">Add User</a> -->
            <?php endif; ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Athlete AMS Status</h4>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-buttons datatable table-bordered table-bordered dt-responsive nowrap"
                                ...
                                <thead class="thead-default">
                                    ...
                                    <tr>
                                        <th class="text-strong">Person</th>
                                        <th class="text-strong">Contact</th>
                                        <th class="text-strong">Category</th>
                                        <th class="text-strong sorting_desc">AMS Last Update</th>
                                    </tr>
                                </thead>
                                <tbody>
...
" ?>
                                            ...
                                            <td>
                                                <?php if ($value['frc_amsLastUpdate'] >= date('Y-m-d')): ?>
                                                    <span style="color: green;"><?= ($value['frc_amsLastUpdate']) ?></span>
                                                    <?php else: ?>
                                                        <span style="color: red;"><?= ($value['frc_amsLastUpdate']) ?></span>
