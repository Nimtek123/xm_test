            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="/usercat/create">
                            <div class="row">
                                ...
                                <div class="mb-2 col-md-6">
                                    <label for="userID" class="form-label">Gender <small>(Male=1, Female=2)</small></label>
                                    <input type="number" class="form-control" id="gender" name="gender" placeholder="Gender">
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-2 col-md-6">
                                ...
                                <div class="mb-2 col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="userID" name="userID" placeholder="userID">
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-2 col-md-6">
